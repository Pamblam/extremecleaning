							...
							<nav role="navigation" class="navbar plain">
								...
								<div id="navbar-collapse-02" class="collapse navbar-collapse">
									<ul class="nav navbar-nav navbar-left">			      
										<li class="active propClone"><a href="index.html" style="color:#fff!important; border-bottom:1px solid #fff; padding-bottom:10px;">Home</a></li>
                                        ...
                                        <li class="propClone dropdown menu-link"><a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background:none;color:#fff!important;"> Services <span class="caret"></span></a>
                                	 		<ul class="dropdown-menu">
                                         		<li class="propClone"><a href="sucide.html" style="color:#0e7f0b!important;">Suicide,Homicide,Unattended Death Cleanup</a></li>
                                      			<li class="propClone"><a href="hoarding.html" style="color:#0e7f0b!important;">Hoarding Cleanup</a></li>
                                                <li class="propClone"><a href="deep_cleaning.html" style="color:#0e7f0b!important;">Deep Cleanings of Homes and Businesses</a></li>
                                      			<li class="propClone"><a href="rodents.html" style="color:#0e7f0b!important;">Rodent Infestation and Advanced Odor Treatment </a></li>
										...
										<li class="propClone"><a href="photo-gallery.html" style="color:#fff!important;">Photo Gallery </a></li>
									
										<li class="propClone"><a href="contact-us.html" style="color:#fff!important;">Contact Us</a></li>
									</ul> 		      
								</div><!-- /.navbar-collapse -->
							</nav>
					...
					<div class="our-expertise44 expert-tabs">
						<div class="container">
                            ...
                            <div class="col-md-4 text-center">
                            	<h2><i class="fa fa-check-circle"></i></h2><a href="sucide.html">Suicide,Homicide,<br>Unattended Death Cleanup</a><p>(Including Blood and Bodily Fluid Spills)</p>
										
								
                            </div>
                            
                             <div class="col-md-4 text-center">
                            	<h2><i class="fa fa-check-circle"></i></h2><a href="hoarding.html">Hoarding Cleanup</a>
                              
                            </div>
                            
                            <div class="col-md-4 text-center">
                            	<h2><i class="fa fa-check-circle"></i></h2><a href="deep_cleaning.html">Deep Cleanings of Homes <br>and Businesses</a>
                            </div>
                            
                              
                            <div class="col-md-12 text-center">
                            	<h2><i class="fa fa-check-circle"></i></h2><a href="rodents.html">Rodent Infestation and Advanced<br> Odor Treatments </a>
                            </div>
						</div>
					</div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 padding-left-0 widgets">
							...
							<div class="quick-links">
								<a href="index.html">Home</a></li>
										<a href="sucide.html">Suicide,Homicide,Unattended Death Cleanup</a>
