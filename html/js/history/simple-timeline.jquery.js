...
if ( typeof Object.create !== 'function' ) {
  ...
  (function( $, window, document, undefinedÂ ) {
      ...
      var Timeline = {
        ...
        changeEvent: function( direction, current) {
            ...
            self.content.each(function() {
              ...
              if (newDate === $this.data("date")) {
                ...
                $('div.blob').animate({"backgroundColor": "#9e9e9e"}, 200);
                ...
                $('.eventButton').each(function() {
                  if('d' + newDate  ===  $(this).attr('id')) {
                    $(this).children( ".blob" ).animate({"backgroundColor": "#0e7f0b"}, 200);
                  }
        ...
        addEvents: function() {
          var self = this,
              ...
              yearLength = 365,     //not supporting skottÃ¥r
              relevantYears = [],
              margins = [],
              marginInd = 0,
              justAdded = 0,
                  ...
                  $.each(relevantYears, function() {
                    ...
                    var date = $(this).data("date"),
                        ...
                        currentTimeline.append('<div class=eventButton id=d' + date + '></div>');
                          ...
                          $('div#d' + date).append('<div class=hoverInfo id=h' + date + '>' + '<span class= datee>  ' + date + '</span></div>');
        ...
        mouseEvents: function() {
            ...
            $('.eventButton').on({
              ...
              mouseenter: function(e) {
                ...
                self.options.content.each(function() {
                  ...
                  if (dateId === $this.data("date")) {
                    ...
                    blob.animate({backgroundColor: "#0e7f0b"}, 300);
              ...
              mouseleave: function(e) {
                ...
                blob.animate({backgroundColor: "#9e9e9e" }, 200);
                } else {
                  blob.animate({backgroundColor: "#0e7f0b"}, 200);
                }
              },
              ...
              click: function(e) {
                ...
                $('.blob').css({backgroundColor: "#9e9e9e"});
                blob.css({backgroundColor: "#0e7f0b" });
                ...
                self.content.each(function() {
                  ...
                  if (dateId === $this.data("date")) {
                    ...
                    //DÃ¶lj det som visades tidigare, om det fanns nÃ¥got
                    self.content.hide();
